...
class HomeScreenPaginated extends StatefulWidget {
  static const String id = 'home_screen_infinite_scroll';
  @override
  _HomeScreenPaginated createState() => _HomeScreenPaginated();
}

class _HomeScreenPaginated extends State<HomeScreenPaginated> {
  String userInput = '';
